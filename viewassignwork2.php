...
<div class="col-sm-6 mt-5  mx-3">
    ...
    if (isset($_REQUEST['view2'])) {
        $sql = "SELECT * FROM assignwork_tb WHERE request_id = {$_REQUEST['id']} AND request_state='1'";
    ...
    <div class="text-center">
        ...
        <form class='d-print-none d-inline' action="workdone.php"><input class='btn btn-secondary' type='submit'
                                                                     value='Close'></form>
