<?php    
session_start();
define('TITLE', 'Atualizar Cliente');
...
include('includes/dbConnection.php');
 ...
 ?>
<div class="  content">
  <h3 class="text-center">Atualizar dados cliente</h3>
  <?php
 ...
 ?>
  <form action="" method="POST">
    <div class="form-group">
      <label for="empId">Identificador Cliente</label>
    ...
    <div class="text-center">
      <button type="submit" class="btn btn-success" id="empupdate" name="empupdate">Atualizar</button>
      <a href="technician.php" class="btn btn-danger">Sair</a>
    </div>
